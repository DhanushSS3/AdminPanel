...
SECRET_KEY = 'django-insecure-%0ms=c2ch3lb9awi^t!c7!)i2^0#(n+o$9i_w%0cqgg@#t$*sq'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DATABASE_NAME', 'u436589492_forex'),
        'USER': os.environ.get('DATABASE_USER', 'u436589492_forex'),
        'PASSWORD': os.environ.get('DATABASE_PASSWORD', 'Setupdev@1998'),
...
SIMPLE_JWT = {
    ...
    'ALGORITHM': 'HS256',
    'SIGNING_KEY': SECRET_KEY,  # Corrected line
    'VERIFYING_KEY': None,
